      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto">
            Have questions about SoloAccountantAI? We'd love to hear from you. Send us a message and we'll respond as soon as possible.
          </p>
        </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-slate-600">We'll notify you when SoloAccountantAI launches.</p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    placeholder="Tell us more about your question or how you'd like to use SoloAccountantAI..."

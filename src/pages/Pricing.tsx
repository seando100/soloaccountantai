...
const Pricing = () => {
  ...
  const STARTER_FEATURES = Array.from({ length: 9 }, (_, i) => t(`pricing.starterFeatures.${i}`));
  const PRO_EXTRAS = Array.from({ length: 6 }, (_, i) => t(`pricing.proFeatures.${i}`));
  const PRO_PLUS_EXTRAS = Array.from({ length: 7 }, (_, i) => t(`pricing.proPlusFeatures.${i}`));

  return (
    <section className="py-24">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-4">{t('pricing.pageTitle')}</h1>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">{t('pricing.pageSubtitle')}</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <Card className="border border-slate-200 flex flex-col">
            <CardHeader className="pb-2 pt-8 px-8">
              ...
              <div className="mb-1"><span className="text-5xl font-bold">$49</span><span className="text-muted-foreground text-lg"> {t('pricing.perMonth')}</span></div>
              <p className="text-sm text-muted-foreground">{t('pricing.perAccountant')}</p>
            </CardHeader>
            <CardContent className="px-8 pb-8 flex flex-col flex-1">
              ...
              <a href="/#waitlist" className="block w-full border border-[#0F2745] text-[#0F2745] text-sm font-medium px-6 py-3.5 rounded-md hover:bg-slate-50 transition text-center">{t('nav.joinWaitlist')}</a>
              <p className="text-xs text-muted-foreground text-center mt-4">{t('pricing.comingSoon')}</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-[#0F2745] flex flex-col relative">
            ...
            <CardHeader className="pb-2 pt-8 px-8">
              ...
              <div className="mb-1"><span className="text-5xl font-bold">$79</span><span className="text-muted-foreground text-lg"> {t('pricing.perMonth')}</span></div>
              <p className="text-sm text-muted-foreground">{t('pricing.perAccountantPro')}</p>
            </CardHeader>
            <CardContent className="px-8 pb-8 flex flex-col flex-1">
              ...
              <a href="/#waitlist" className="block w-full bg-[#0F2745] text-white text-sm font-medium px-6 py-3.5 rounded-md hover:bg-[#0C2038] transition text-center">{t('nav.joinWaitlist')}</a>
              <p className="text-xs text-muted-foreground text-center mt-4">{t('pricing.comingSoon')}</p>
            </CardContent>
          </Card>
          ...
          <Card className="border border-slate-200 flex flex-col relative">
            <CardHeader className="pb-2 pt-8 px-8">
              ...
              <div className="mb-1"><span className="text-5xl font-bold">$119</span><span className="text-muted-foreground text-lg"> {t('pricing.perMonth')}</span></div>
              <p className="text-sm text-muted-foreground">{t('pricing.perAccountantProPlus')}</p>
            </CardHeader>
            <CardContent className="px-8 pb-8 flex flex-col flex-1">
        ...
        <div className="text-center mt-20">
          ...
          <a href="/#waitlist" className="bg-[#0F2745] text-white px-6 py-3 rounded-md text-sm font-medium hover:bg-[#0C2038] transition inline-flex items-center">{t('nav.joinWaitlist')} <ArrowRight className="ml-2 h-4 w-4" /></a>
        </div>
      </div>
    </section>
  );

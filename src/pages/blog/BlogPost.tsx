...
const BlogPost = () => {
  ...
  const category = lang === 'es' && post.categoryEs ? post.categoryEs : post.category;
  const date = lang === 'es' && post.dateEs ? post.dateEs : post.date;
    ...
    <div>
      ...
      <section className="max-w-3xl mx-auto px-6 pb-16">
        <div className="bg-[#0F2745] rounded-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-gray-300 mb-6">{t('blog.ctaSubtitle')}</p>

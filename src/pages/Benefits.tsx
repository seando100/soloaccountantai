          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-xs font-semibold text-violet-600 uppercase tracking-wider mb-1">For Clients</p>
                  <p className="text-sm text-slate-500 leading-relaxed">Your accountant has your information organized and ready before your first consultation. Faster follow-ups, fewer repeat questions.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-xs font-semibold text-violet-600 uppercase tracking-wider mb-1">For Clients</p>
                  <p className="text-sm text-slate-500 leading-relaxed">Find helpful, expert financial content from a local accountant you can trust — not generic internet advice. When you're ready, your accountant is one click away.</p>
                </div>
              </div>
            </div>
          </div>
